...
def modify(session, residues, res_type, *, angle_slop=None, bfactor=None, criteria=default_criteria,
    ...
    from . import do_ptm
    do_ptm.modify(session, residues, res_type, bfactor=bfactor, clash_hbond_allowance=hbond_allowance,
...
def rotamers(session, residues, res_type, *, rot_lib=None, log=True):
    ...
    for r in residues:
        ...
        rotamers = do_ptm.get_rotamers(session, r, res_type=r_type, rot_lib=rot_lib, log=log)
...
def register_command(command_name, logger):
    ...
    register("modify", desc, modify, logger=logger)
    ...
    register("modify interactive", desc, rotamers, logger=logger)
