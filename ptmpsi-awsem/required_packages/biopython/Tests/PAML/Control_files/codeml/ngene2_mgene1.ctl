      seqfile = ../../Alignments/lysinYangSwanson2002.nuc
     treefile = ../../Trees/lysin.trees

      outfile = codeml_ngene2_mgene1.out          * main result file name
    ...
    CodonFreq = 2   * 0:1/61 each, 1:F1X4, 2:F3X4, 3:codon table
      ...
      NSsites = 0   * 0:one w;1:neutral;2:positive; 3:discrete;4:freqs;
        ...
        Mgene = 1   * codonml: 0:rates, 1:separate; 2:diff pi, 3:diff kapa, 4:all diff
